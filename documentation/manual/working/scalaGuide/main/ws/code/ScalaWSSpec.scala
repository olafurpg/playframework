...
class ScalaWSSpec extends PlaySpecification with Results {
  ...
  "WS" should {
    ...
    "allow working with clients directly" in withSimpleServer { ws =>
      ...
      val secureDefaults: AsyncHttpClientConfig =
