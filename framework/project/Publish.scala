...
object ResolverSettings {
  ...
  val publishSonatypeSnapshots =
    "Sonatype Maven Snapshots Repository for publishing" at "https://oss.sonatype.org/content/repositories/snapshots"
...
object PublishSettings {
  ...
  private def commonPublishSettings: Seq[Setting[_]] =
    Seq(
