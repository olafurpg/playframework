...
case class ParserConfiguration(
    maxMemoryBuffer: Int = 102400, maxDiskBuffer: Long = 10485760)
...
object HttpConfiguration {
  ...
  /**
    ...
    */
  def current =
    Play.maybeApplication.fold(HttpConfiguration())(httpConfigurationCache)
}
