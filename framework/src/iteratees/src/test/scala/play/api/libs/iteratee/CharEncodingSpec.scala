...
object CharEncodingSpec extends Specification {
  ...
  "CharEncodingSpec.decode()" should {
    ...
    "decode US-ASCII" in {
      ...
      val result =
        Enumerator(input:_*) &> CharEncoding.decode("US-ASCII") |>>> Iteratee.consume[String]()
      Await.result(result, Duration.Inf) must be equalTo new String(input.flatten.toArray,
                                                                    "US-ASCII")
    }
    ...
    "decode UTF-8" in {
      ...
      val result =
        Enumerator(input:_*) &> CharEncoding.decode("UTF-8") |>>> Iteratee.consume[String]()
    ...
    "decode UTF-16" in {
      ...
      val result =
        Enumerator(input:_*) &> CharEncoding.decode("UTF-16") |>>> Iteratee.consume[String]()
    ...
    "decode UTF-32" in {
      ...
      val result =
        Enumerator(input:_*) &> CharEncoding.decode("UTF-32") |>>> Iteratee.consume[String]()
      Await.result(result, Duration.Inf) must be equalTo "Hello World"
    }
  ...
  "CharEncodingSpec.encode()" should {
    ...
    "encode US-ASCII" in {
      ...
      val result =
        Enumerator(input:_*) &> CharEncoding.encode("US-ASCII") |>>> Iteratee.consume[Array[Byte]]()
    ...
    "encode UTF-8" in {
      ...
      val result =
        Enumerator(input:_*) &> CharEncoding.encode("UTF-8") |>>> Iteratee.consume[Array[Byte]]()
    ...
    "encode UTF-16" in {
      ...
      val result =
        Enumerator(input:_*) &> CharEncoding.encode("UTF-16") |>>> Iteratee.consume[Array[Byte]]()
    ...
    "encode UTF-32" in {
      ...
      val result =
        Enumerator(input:_*) &> CharEncoding.encode("UTF-32") |>>> Iteratee.consume[Array[Byte]]()
