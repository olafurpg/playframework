...
object ConnectionPool {
  ...
  def fromConfig(config: String,
    ...
    config match {
      ...
      case fqcn =>
        injector.instanceOf(Reflect.getClass[ConnectionPool](fqcn, environment.classLoader))
    }
  }
  ...
  /**
    ...
    */
  def extractUrl(
      maybeUrl: Option[String], mode: Mode.Mode): (Option[String], Option[(String, String)]) = {
