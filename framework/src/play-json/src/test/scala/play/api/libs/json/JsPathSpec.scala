  ...
  "JsPath" should {
    ...
    "retrieve 1-level recursive path" in {
      ...
      (JsPath \\ "tags")(obj) must equalTo(
          Seq(Json.arr("alpha1", "beta1", "gamma1"), Json.arr("alpha2", "beta2", "gamma2")))
    }
    ...
    "retrieve recursive in jsobject and jsarray 2" in {
      val obj = Json.obj(
          ...
          "array" -> Json.arr(
              ...
              Json.obj("field" -> Json.obj("alpha" -> "v21",
                                           "gamma" -> "v23",
                                           "beta" -> "v22")),
    ...
    "prune field from 1-level JsObject" in {
      ...
      (__ \\ 'key21).prune(obj) must beEqualTo(
          JsError(__ \\ "key21", ValidationError("error.expected.keypathnode")))
    }
